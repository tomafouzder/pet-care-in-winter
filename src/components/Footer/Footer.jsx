...
import iconImg from "../../assets/doggy_2.jpg"
        ...
        <footer className=" bg-gray-800 mt-10 p-10">
                ...
                <div className='flex flex-col lg:flex-row md:text-center  justify-between gap-10 text-base-center pt-5 items-center">
                    ...
                    <div>
                        ...
                        <div className=" flex justify-center items-center ">
                            ...
                            <p className=" text-white font-bold text-5xl">PetCare
            ...
            <div className='text-center border-t border-gray-700 mt-8 py-4 text-gray-400 text-sm'>
                <p>&copy; {new Date().getFullYear()}
                    <span className='text-orange-500 font-semibold'>PetCare In Winter</span>
